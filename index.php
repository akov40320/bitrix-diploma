        ...
        <div class="slider slick-good-slider">
            <div class="slider__item">
                <div class="slider__item-wrp">
                    <img src="/bicycle-main/img/good-1.jpg" alt="good-1">
...
<section class="ride-us">
    <img src="/bicycle-main/img/ride-with-us-bycicle.jpg" alt="ride-us-pic">
    <a href="#">по городу</a>
</section>
        ...
        <div class="slider slick-city-slider">
            <div class="slider__item">
                <div class="city-bike__slide-wrp">
                    <img src="/bicycle-main/img/city-bike.png" alt="city-bike">
            ...
            <div class="slider__item">
                <div class="city-bike__slide-wrp">
                    <img src="/bicycle-main/img/city-bike.png" alt="city-bike">
                    <div class="city-bike__content">
                        <p>Дополнительные аксессуары для городских велосипедов. Все самое нужное и полезное. Без этих штучек ваша дорога будет скучна и безрадостна. Просто необходимо их приобрести</p>
...
<section class="sale">
    <div class="container sale__wrp">
        ...
        <div class="sale__img-wrp">
            <img src="/bicycle-main/img/helmet.png" alt="helmet">
        </div>
    </div>
</section>
